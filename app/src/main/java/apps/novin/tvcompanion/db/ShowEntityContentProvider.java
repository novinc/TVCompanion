...
<application> element:
    ...
    <provider
            android:name="apps.novin.tvcompanion.db.ShowEntityContentProvider"
            android:authorities="apps.novin.tvcompanion.db.provider"/>
    */

public class ShowEntityContentProvider extends ContentProvider {
    ...
    private static final String TABLENAME = ShowEntityDao.TABLENAME;
    private static final String PK = ShowEntityDao.Properties.Id
            .columnName;

    private static final int SHOWENTITY_DIR = 0;
    private static final int SHOWENTITY_ID = 1;

    private static final UriMatcher sURIMatcher;

    static {
        sURIMatcher = new UriMatcher(UriMatcher.NO_MATCH);
        sURIMatcher.addURI(AUTHORITY, BASE_PATH, SHOWENTITY_DIR);
        sURIMatcher.addURI(AUTHORITY, BASE_PATH + "/#", SHOWENTITY_ID);
    }
